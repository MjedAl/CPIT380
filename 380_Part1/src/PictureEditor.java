...
public class PictureEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ConvertToHSV = new javax.swing.JToggleButton();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(scaleSlider, javax.swing.GroupLayout.DEFAULT_SIZE, 626, Short.MAX_VALUE)
                .addContainerGap())
        );
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 708, Short.MAX_VALUE)
...
//            Image img = (pic.getImage()).getScaledInstance(imgLabel.getWidth(), imgLabel.getHeight(), Image.SCALE_SMOOTH);;
            ...
            imgLabel.setSize(pic.getWidth(), pic.getHeight());
            imgLabel.setIcon(new ImageIcon(pic.getImage()));
            updateIMG();
        }
    ...
    private void ConvertToHSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConvertToHSVActionPerformed
        if (pic != null) {
            ...
            for (int i = 0; i < pxs.length; i++) {
                Color c = pxs[i].getColor();

                System.out.println(c.getRed() + " " + c.getGreen() + " " + c.getBlue());
                float[] hsb = Color.RGBtoHSB(c.getRed(), c.getGreen(), c.getBlue(), null);
                System.out.println(hsb[0] * 360 + " " + hsb[1] * 100 + " " + hsb[2] * 100);
...
//                System.out.println(c.getRed() + " " + c.getGreen() + " " + c.getBlue());
    ...
    private javax.swing.JToggleButton ConvertToHSV;
